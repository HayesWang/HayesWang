        ...
        NavigationView {
            VStack {
                VStack {
                    VStack {
                        ZStack(alignment: .topTrailing) {
                            Group {
                                FSPagerViewSUI($dhi2ViewModel.sliderstartCurrentPage,
                                               dhi2ViewModel.sliderData) { item in
                                    ZStack(alignment: .trailing) {
                                        VStack {
                                            ...
                                            .onTapGesture {
                                                dhi2ViewModel.nextScreen = "FreeexerciseView"
                                            }
                                ...
                                Image("img_ellipse38_226x174")
                                    ...
                                    .padding(.leading, getRelativeWidth(219.0))
                                Image("img_ellipse39_372x263")
                                    .resizable()
                        ...
                        ZStack(alignment: .center) {
                            ...
                            PageIndicator(numPages: dhi2ViewModel.sliderData.count,
                                          currentPage: $dhi2ViewModel.sliderstartCurrentPage,
                        ...
                        HStack {
                            HStack {
                                ...
                                TextField(StringConstants.kLblHome, text: $dhi2ViewModel.homeText)
                                    .font(FontScheme
                            ...
                            Image("img_info_white_a700")
                                ...
                                .onTapGesture {
                                    dhi2ViewModel.nextScreen = "InfoView"
                                }
                        }
                ...
                Group {
                    ...
                    NavigationLink(destination: Dhi3View(),
                                   tag: "Dhi3View",
                                   selection: $dhi2ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
