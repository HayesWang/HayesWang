                ...
                VStack {
                    VStack {
                        ZStack(alignment: .topLeading) {
                            Group {
                                FSPagerViewSUI($dhi1ViewModel.sliderstartCurrentPage,
                                               dhi1ViewModel.sliderData) { item in
                                    ZStack(alignment: .trailing) {
                                        VStack {
                                            ...
                                            .onTapGesture {
                                                dhi1ViewModel.nextScreen = "FreeexerciseView"
                                            }
                        ...
                        ZStack(alignment: .center) {
                            ...
                            PageIndicator(numPages: dhi1ViewModel.sliderData.count,
                                          currentPage: $dhi1ViewModel.sliderstartCurrentPage,
                        ...
                        HStack {
                            HStack {
                                ...
                                TextField(StringConstants.kLblHome, text: $dhi1ViewModel.homeText)
                                    .font(FontScheme
                            ...
                            Image("img_info_white_a700")
                                ...
                                .onTapGesture {
                                    dhi1ViewModel.nextScreen = "InfoView"
                                }
                        }
