...
struct Dhi3View: View {
    @StateObject var dhi3ViewModel = Dhi3ViewModel()
                ...
                VStack {
                    VStack {
                        ZStack(alignment: .topLeading) {
                            Group {
                                FSPagerViewSUI($dhi3ViewModel.sliderstartCurrentPage,
                                               dhi3ViewModel.sliderData) { item in
                                    ZStack(alignment: .trailing) {
                                        VStack {
                                            ...
                                            .onTapGesture {
                                                dhi3ViewModel.nextScreen = "FreeexerciseView"
                                            }
                        ...
                        ZStack(alignment: .center) {
                            ...
                            PageIndicator(numPages: dhi3ViewModel.sliderData.count,
                                          currentPage: $dhi3ViewModel.sliderstartCurrentPage,
                        ...
                        HStack {
                            HStack {
                                ...
                                TextField(StringConstants.kLblHome, text: $dhi3ViewModel.homeText)
                                    .font(FontScheme
                            ...
                            Image("img_info_white_a700")
                                ...
                                .onTapGesture {
                                    dhi3ViewModel.nextScreen = "InfoView"
                                }
                        }
