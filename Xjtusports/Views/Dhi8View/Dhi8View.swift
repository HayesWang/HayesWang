...
struct Dhi8View: View {
    @StateObject var dhi8ViewModel = Dhi8ViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                    ...
                    VStack {
                        ...
                        HStack {
                            HStack {
                                ...
                                TextField(StringConstants.kLblHome, text: $dhi8ViewModel.homeText)
                                    .font(FontScheme
                            ...
                            Image("img_info_white_a700")
                                ...
                                .onTapGesture {
                                    dhi8ViewModel.nextScreen = "InfoView"
                                }
                        }
                ...
                .padding(.bottom, getRelativeHeight(10.0))
                Group {
                    NavigationLink(destination: Dhi9View(),
                                   tag: "Dhi9View",
                                   selection: $dhi8ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Dhi8View_Previews: PreviewProvider {
