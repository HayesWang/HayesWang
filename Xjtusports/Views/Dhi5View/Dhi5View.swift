...
struct Dhi5View: View {
    @StateObject var dhi5ViewModel = Dhi5ViewModel()
            ...
            VStack {
                ZStack(alignment: .center) {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: 0) {
                                ...
                                Button(action: {}, label: {
                                    ...
                                    .onTapGesture {
                                        dhi5ViewModel.nextScreen = "DetailView"
                                    }
                                })
                                .frame(width: getRelativeWidth(99.0),
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            ZStack(alignment: .topTrailing) {
                                ZStack(alignment: .topLeading) {
                                    FSPagerViewSUI($dhi5ViewModel.sliderexaminegradeCurrentPage,
                                                   dhi5ViewModel.sliderData) { item in
                                        ZStack(alignment: .trailing) {
                                            VStack(alignment: .leading, spacing: 0) {
                                                Text(StringConstants.kLblExamineGrade)
                                                    .font(FontScheme
                                        ...
                                        .frame(width: getRelativeWidth(335.0),
                                               height: getRelativeHeight(185.0))
                                    }
                                    Text(StringConstants.kLblContent)
                                        ...
                                        .padding(.trailing, getRelativeWidth(301.0))
                                }
                                .hideNavigationBar()
                                .frame(width: UIScreen.main.bounds.width,
                                       height: getRelativeHeight(379.0),
                                ...
                                HStack {
                                    ZStack(alignment: .leading) {
                                        ...
                                        ZStack {}
                                            ...
                                            .onTapGesture {
                                                dhi5ViewModel.nextScreen = "FreeexerciseView"
                                            }
                                    }
                                    .hideNavigationBar()
                                    .frame(width: getRelativeWidth(143.0),
                                    ...
                                    ZStack(alignment: .leading) {
                                        ...
                                        ZStack {}
                                            ...
                                            .background(RoundedCorners(topLeft: 20.0,
                                                    ...
                                                    .fill(ColorConstants.Bluegray10005))
                                            .onTapGesture {
                                                dhi5ViewModel.nextScreen = "Dhi7View"
                                            }
                                    }
                                    .hideNavigationBar()
                                    .frame(width: getRelativeWidth(143.0),
                        ...
                        ZStack(alignment: .center) {
                            ...
                            PageIndicator(numPages: dhi5ViewModel.sliderData.count,
                                          currentPage: $dhi5ViewModel.sliderexaminegradeCurrentPage,
                ...
                Group {
                    NavigationLink(destination: FreeexerciseView(),
                                   ...
                                   selection: $dhi5ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Dhi5View_Previews: PreviewProvider {
