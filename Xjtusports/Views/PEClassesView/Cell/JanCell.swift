    ...
    var body: some View {
        ZStack(alignment: .center) {
            Text(StringConstants.kLblJan)
                .font(FontScheme.kRubikItalicBlack(size: getRelativeHeight(64.0)))
                .fontWeight(.black)
                .foregroundColor(ColorConstants.Black900)
                .minimumScaleFactor(0.5)
                .multilineTextAlignment(.leading)
                .frame(width: getRelativeWidth(132.0), height: getRelativeHeight(76.0),
                       alignment: .leading)
                .padding(.bottom, getRelativeHeight(168.08))
                .padding(.trailing, getRelativeWidth(167.15))
            VStack(alignment: .trailing, spacing: 0) {
                    ...
                    Text(StringConstants.kLbl1)
                        ...
                        .overlay(RoundedCorners(topLeft: 17.0, topRight: 17.0, bottomLeft: 17.0,
                                ...
                                .stroke(ColorConstants.Black900,
                                        lineWidth: 1))
                        .background(ColorConstants.IndigoA200)
                ...
                .frame(width: getRelativeWidth(203.0), height: getRelativeHeight(34.0),
                       alignment: .leading)
                .padding(.leading)
                .padding(.leading)
                HStack {
                    ...
                    Button(action: {}, label: {
                        HStack(spacing: 0) {
                            Text(StringConstants.kLbl29)
                                ...
                                .background(RoundedCorners(topLeft: 17.5, topRight: 17.5,
                                                           bottomLeft: 17.5, bottomRight: 17.5)
                                        .fill(ColorConstants.IndigoA201))
                                .padding(.leading, getRelativeWidth(8.0))
                        }
                    })
                    .frame(width: getRelativeWidth(33.0), height: getRelativeHeight(34.0),
            ...
            .frame(width: getRelativeWidth(289.0), height: getRelativeHeight(202.0),
                   alignment: .leading)
...
/* struct JanCell_Previews: PreviewProvider {
