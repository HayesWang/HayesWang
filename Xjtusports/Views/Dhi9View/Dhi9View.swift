...
struct Dhi9View: View {
    @StateObject var dhi9ViewModel = Dhi9ViewModel()
            ...
            VStack {
                    ...
                    VStack {
                            ...
                            ZStack(alignment: .center) {
                                VStack {
                                    ...
                                    ZStack(alignment: .trailing) {
                                        Image("img_vector_white_a700_25x38")
                                            .resizable()
                                            ...
                                            .scaledToFit()
                                            .clipped()
                                            .padding(.leading, getRelativeWidth(42.92))
                                            .padding(.trailing, getRelativeWidth(103.08))
                                    ...
                                    .overlay(RoundedCorners(topLeft: 27.0, topRight: 27.0,
                        ...
                        HStack {
                            HStack {
                                ...
                                TextField(StringConstants.kLblHome, text: $dhi9ViewModel.homeText)
                                    .font(FontScheme
                            ...
                            Image("img_info_white_a700")
                                ...
                                .onTapGesture {
                                    dhi9ViewModel.nextScreen = "InfoView"
                                }
                        }
                ...
                Group {
                    NavigationLink(destination: InfoView(),
                                   tag: "InfoView",
                                   selection: $dhi9ViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct Dhi9View_Previews: PreviewProvider {
